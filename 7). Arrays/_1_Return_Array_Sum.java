...
public class /* Solution */ _1_Return_Array_Sum { // Note:- remove comment before submit to coding ninjas platform.
    // take array input.
 ...
 * Return Array Sum
 * Send Feedback
 * Given an array/list(ARR) of length N, you need to find and return the sum of
