...
public class /* Solution */ _4_Pair_Sum {
 ...
 * Pair Sum
 * Send Feedback
 * You have been given an integer array/list(ARR) and a number X. Find and
 ...
 * Output format :
 * For each test case, print the total number of pairs present in the
 * array/list.
 * 
