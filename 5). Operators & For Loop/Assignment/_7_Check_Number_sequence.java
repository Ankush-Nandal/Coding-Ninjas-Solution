...
public class /* Main */ _7_Check_Number_sequence {
 ...
 * The series is :
 * 8 7 6 5 8 2
 * It is strictly decreasing first (8 7 6 5). Then it's strictly increasing (5
 * 8). But then it starts strictly decreasing again (8 2). Therefore, the output
 * for this test case is 'false'
 */